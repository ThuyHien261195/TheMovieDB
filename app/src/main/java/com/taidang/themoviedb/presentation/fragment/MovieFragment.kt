...
import com.taidang.themoviedb.presentation.adapter.pagerAdapter.MovieContentPagerAdapter
 ...
 */
class MovieFragment() : BaseMediaPagerFragment() {

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        val adapter = MovieContentPagerAdapter(this.context!!, this.childFragmentManager)
